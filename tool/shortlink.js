...
let shortlink = (ctx, data, cookie) => {
    ...
    switch (data.type) {
        case 'main':
            let targetMain =  encodeURIComponent(`https://mgdg.shop/#/home?shareId=${shareId}`)
        ...
        case 'wx':
            ...
            break;
        case 'goods':
            let targetGoods =  encodeURIComponent(`https://mgdg.shop/#/good/detail?id=${data.data}&shareId=${shareId}`)
